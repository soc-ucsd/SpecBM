...
%%%%%%%%%% [Dual] %%%%%%%%%%
    ...
    opts.MaxCols = 3; opts.EvecPast = 2; opts.EvecCurrent = 1;
    Out_Dual_2_1 = SBMD(At_sdp,b_sdp,c_sdp,K_sdp,opts);

    opts.Maxiter = 300;
    opts.rho     = Optimal.TrX*2+1;
    opts.MaxCols = 5; opts.EvecPast = 4; opts.EvecCurrent = 1;
    Out_Dual_4_1 = SBMD(At_sdp,b_sdp,c_sdp,K_sdp,opts);

    opts.Maxiter = 300;
    opts.rho     = Optimal.TrX*2+1;
    opts.MaxCols = 10; opts.EvecPast = 9; opts.EvecCurrent = 1;
    Out_Dual_9_1 = SBMD(At_sdp,b_sdp,c_sdp,K_sdp,opts);
  
    opts.Maxiter = 300;
    opts.rho     = Optimal.TrX*2+1;
    opts.MaxCols = 3; opts.EvecPast = 0; opts.EvecCurrent = 3;
    Out_Dual_0_3 = SBMD(At_sdp,b_sdp,c_sdp,K_sdp,opts);
     
    opts.Maxiter = 300;
    opts.rho     = Optimal.TrX*2+1;
    opts.MaxCols = 5; opts.EvecPast = 0; opts.EvecCurrent = 5;
    Out_Dual_0_5 = SBMD(At_sdp,b_sdp,c_sdp,K_sdp,opts);
    
    opts.Maxiter  = 300;
    opts.rho      = Optimal.TrX*2+1;
    opts.MaxCols  = 10; opts.EvecPast = 0; opts.EvecCurrent = 10;
