...
%             iter,f1,EstimatedDrop,PrimalFeasi(iter),DualSemiFeasi(iter), Gap(iter),Paras.alpha,toc(AlgorithmTime));
            fprintf('%5d  %7.2e  %7.2e  %9.2e  %9.2e  %8.2e  %8.2e  %8.2e \n',...
            iter,f1,RelativeAccuracy,RelativePFeasi,0, RelativeGap,Paras.alpha,toc(AlgorithmTime));
        end
    end
    Out.Obj         = Obj;
