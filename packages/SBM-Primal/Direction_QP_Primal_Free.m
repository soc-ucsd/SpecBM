function [Wstar,X_next,Gammastar,Sstar,DualFeasibility_psd,DualFeasibility_free,gap,y,x_next,DualFeasibility] = Direction_QP_Primal_Free(omegat_free,omegat_psd,Paras,Wt,Pt,feasible)
    ...
    temp = 2*(-Paras.c_sdp+Paras.alpha*omegat_psd);
    q1   = Wt.'*temp;
    q2T  = temp.'*kronPtPt;
    q2  = q2T.';
